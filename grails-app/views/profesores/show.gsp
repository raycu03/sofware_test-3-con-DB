...
<html>
    ...
    <body>
        ...
        <div id="show-profesores" class="content scaffold-show" role="main">
            ...
            <f:display bean="profesores" />
            <g:form resource="${this.profesores}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.profesores}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
